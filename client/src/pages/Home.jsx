...
import banner from "../images/symbol.mp4";
              ...
              <div className="row">
                <div className="col-lg-6 align-self-center">
                  ...
                  >
                    <div className="row">
                      <div className="col-lg-12">
                        <h2>CPC: Visualizing Algorithms</h2>
                        <p style={{ fontSize: "1rem" }}>
                          CPC is a web application that allows users to learn
                          about algorithms by visualizing them. Users can choose
                          from a variety of algorithms and customize their
                          parameters to see how they work. CPC also allows
                ...
                <div className="col-lg-6">
                  <div
                    ...
                    data-wow-delay="0.5s"
                  >
                    <video src={banner} autoPlay loop muted style={{width:"800px",height:"500px"}} />
                  </div>
                </div>
              </div>
            </div>
